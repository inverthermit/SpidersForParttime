...
public class InputMaster2 {
	...
	public static void main(String[] args) throws Exception {
		...
		File inputFile = new File(FILE_PATH + "\\" + "gen_dataMaster.xls");
		InputStream os = null;
		Workbook book=null;
		Sheet sheet=null;
		try {
		...
		for(int i=1;i<=84;i++){
			...
			FileOutputStream o=new FileOutputStream(new File("d:/ASTON/temp.txt"));
			o.write(structure.getBytes());
			o.close();
			BufferedReader fis = new BufferedReader(new FileReader("d:/ASTON/temp.txt"));
			String title="";
			String text="";
			String line="";
			int index=0;
