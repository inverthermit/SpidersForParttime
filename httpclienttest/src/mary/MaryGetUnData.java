...
public static String FILE_PATH="d:\\MARY";
	...
	public static void WriteToExcel()
	{
		...
		int j=0;
		String url="";
		for(;i<getURL.underUrls.length+1;i++)
		{
			//if(i>=22)
			{
				System.out.println(i+":"+getURL.underUrls[i-1][0]);
					HashMap<String,String> data=MaryGetDetails(getURL.underUrls[i-1]);
					for(j=0;j<13;j++)
						{
