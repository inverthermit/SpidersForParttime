...
public class InputMaster {
	...
	public static void main(String[] args) throws Exception {
		...
		Map<String, List<String>> scholarshipMap = Scholarship
				.getScholarshipMap(FILE_PATH
						+ "\\gen_data_school_scholarship.xls");

		int j = 0;
		for (int i = 76; i <= 141; i++) {
			j = 0;
			...
			driver.findElement(By.xpath("//div[@class='panel-heading']"))
					.findElements(By.tagName("a")).get(index - 1).click();
			...
			while ((line = fis.readLine()) != null) {
				...
				if (line.equals("Year 1") || line.equals("Year 2")
						|| line.equals("Year 3") || line.equals("Year 4")) {
					if (index != 0) {
			...
			for (String str : scholarshipMap.get(sheet.getCell(2, i)
					.getContents())) {
				driver.findElement(By.id("inputScholarshipName")).sendKeys(
				 ...
				 * str.substring(0, str.indexOf("￥")) + "\"");
				 */
				driver.findElement(By.id("inputScholarshipValue")).sendKeys(
				 ...
				 */
				driver.findElement(
						By.xpath("//button[@ng-click='addScholarship()']"))
						.click();
			}
